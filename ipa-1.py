...
def savings(gross_pay, tax_rate, expenses):
    ...
    tax = gross_pay * tax_rate # tax amount
    tax_rounded = math.floor(tax) #round down tax
    net_savings = gross_pay - tax - expenses 
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    # Replace `pass` with your code.
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    job_wastes = num_jobs * job_consumption #waste of a set of jobs 
    total_wastes = total_material - (job_wastes)
    total_wastes_with_units = str(total_wastes) + str(material_units)
    return total_wastes_with_units
...
def interest(principal, rate, periods):
    ...
    interest_rounded = math.floor(interest)
...
def body_mass_index(weight, height):
    ...
    height_squared = height_meters**2
    bmi_computation = weight_kg / height_squared
    
    return bmi_computation
